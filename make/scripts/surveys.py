...
# Define folders
folders = {
    "treatment/eod": flat(survey_pages[("all","eod")]),
    ...
    "treatment/biweekly/1": flat(survey_pages[("all","biweekly")]) + flat(survey_pages[("2","biweekly")]),
    "treatment/biweekly/2": flat(survey_pages[("all","biweekly")]) + flat(survey_pages[("4","biweekly")]),
    "treatment/biweekly/3": flat(survey_pages[("all","biweekly")]) + flat(survey_pages[("6","biweekly")]),
    ...
    "control/biweekly/4": flat(survey_pages[("8","biweekly_control")]),
}
